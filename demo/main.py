...
treatment_info = {
    'AMD': "Treatment for AMD depends on the type (dry or wet) and severity. For dry AMD: management typically involves lifestyle changes such as a diet rich in antioxidants certain vitamins and minerals (like vitamin C, E, zinc, copper, lutein, and zeaxanthin) and quitting smoking.For wet AMD: treatments may include injections of medications called anti-VEGF drugs, photodynamic therapy, or laser surgery.",
    ...
    'Glaucoma': "Treatment aims to lower intraocular pressure to prevent further damage to the optic nerve. Eye drops are usually the first line of treatment. These medications help reduce intraocular pressure. Laser trabeculoplasty or conventional surgery may be necessary if eye drops are ineffective.",
    'Myopia': "Eyeglasses or contact lenses are the most common and effective ways to correct myopia. Orthokeratology involves wearing specially designed contact lenses overnight to reshape the cornea temporarily.",
